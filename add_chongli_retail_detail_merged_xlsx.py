"""一次性产物：崇礼旗舰店零售财年报表按「七色米订单号」合并展示商品明细。
...
明细源说明（与南山的唯一口径差异）：
    ...
    **不做**「明细记录是否存在于本报表」的反向核对（某条明细不在崇礼，
    可能属于其他门店，属正常）。
    红色 FF9999 仍保留：表示「本报表内非关闭单未匹配到明细」的正向异常。

输出形态（与南山一致）：
    [1] 另存独立备份 chongli_retail_orders_fy_with_detail.xlsx（单 sheet）
...
用法（确保产物未被 Excel 打开；源报表被打开不影响，只读加载）：
    python3 add_chongli_retail_detail_merged_xlsx.py
"""
import os
import sys
...
SRC_XLSX = os.path.join(
    BASE, "chongli_retail_orders_fy_2025-05-01_2026-04-30.xlsx")
OUT_XLSX = os.path.join(
    BASE, "chongli_retail_orders_fy_with_detail.xlsx")
...
# 用户指定剔除：21 笔微额 ¥0.0x + 4 笔 ¥0 测试单（均无七色米号，无明细）。
# 23 笔实额（¥100–¥7850）不剔除，保持标红（真实订单缺七色米引用）。
EXCLUDE_CODES = {
    "QJ_LS_251009_00002", "QJ_LS_251009_00003", "QJ_LS_251010_00005",
    "QJ_LS_251010_00007", "QJ_LS_251011_00002", "QJ_LS_251011_00004",
    "QJ_LS_251011_00005", "QJ_LS_251011_00013", "QJ_LS_251012_00018",
    "QJ_LS_251012_00019", "QJ_LS_251012_00020", "QJ_LS_251012_00021",
    "QJ_LS_251013_00001", "QJ_LS_251013_00002", "QJ_LS_251013_00003",
    "QJ_LS_251013_00004", "QJ_LS_251013_00005", "QJ_LS_251013_00006",
    "QJ_LS_251028_00005", "QJ_LS_251130_00002", "QJ_LS_251231_00002",
    "QJ_LS_251008_00006", "QJ_LS_251008_00008", "QJ_LS_251028_00003",
    "QJ_LS_251028_00004",
}
CODE_HEADER = "订单号"
